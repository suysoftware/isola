...
class IsolaUserMeta {
  ...
  IsolaUserMeta(this.userEmail, this.userToken, this.userLocLongitude,
      this.userLocLatitude, this.joinedGroupList,this.userUid,this.userIsValid,this.userActivities,this.userFriends,this.userBlocked);
