...
class ChaosGroupSettingCubit extends Cubit<ChaosGroupSettingModel> {
  ...
  ChaosGroupSettingCubit(this.chaosGroupSettingModel)
      : super(chaosGroupSettingModel);

  void chaosGroupSettingChanger(
      ChaosGroupSettingModel _chaosGroupSettingModel) {
